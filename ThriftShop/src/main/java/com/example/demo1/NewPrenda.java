...
public class NewPrenda {
    ...
    public void CreateNewPrenda(ActionEvent event) throws IOException{
        File targetFolder = new File(HelloApplication.path + "com\\example\\demo1\\images");
        ...
        try  {
            BufferedWriter writer = new BufferedWriter(new FileWriter(HelloApplication.path + "prendas.txt",true));
